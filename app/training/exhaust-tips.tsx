...
const ASSETS = {
  ...
  steelWool:    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663471903126/PgjXXPdhTyflzwoX.png",
...
const STEPS: Step[] = [
  {
    id: "step1",
    title: "Step 1 — Apply Degreaser to Exhaust Tips",
    instruction: "Spray degreaser on the exhaust tips to break down carbon buildup, soot, and road grime. Let it dwell for 30-60 seconds.",
    area: "💨 Exhaust Tips",
    question: "Which chemical do you apply first to exhaust tips?",
    choices: [
    ...
    correctId: "degreaser",
    wrongExplanation: "❌ Wrong! Brake Buster is for wheels and tires. Exhaust tips need Degreaser to break down carbon buildup and soot.",
    correctExplanation: "✅ Correct! Degreaser is the first product applied to exhaust tips — it breaks down carbon, soot, and road grime.",
    proTip: "💡 Pro Tip: Spray degreaser inside the exhaust tip as well as outside. Carbon buildup inside the tip is just as visible.",
  },
  {
    id: "step2",
    title: "Step 2 — Scrub with Steel Wool",
    instruction: "Use steel wool to scrub the exhaust tip in circular motions. Steel wool removes stubborn carbon deposits and oxidation that brushes can't reach.",
    area: "💨 Exhaust Tips — Scrubbing",
    question: "Which tool do you use to scrub exhaust tips?",
    choices: [
      { id: "greenBrush",  label: "Green Brush",  image: ASSETS.greenBrush },
      { id: "steelWool",   label: "Steel Wool",   image: ASSETS.steelWool },
      { id: "detailBrush", label: "Detail Brush", image: ASSETS.detailBrush },
    ],
    correctId: "steelWool",
    wrongExplanation: "❌ Wrong! Brushes can't remove stubborn carbon deposits from exhaust tips. Steel Wool is the correct tool for this.",
    correctExplanation: "✅ Correct! Steel Wool removes carbon deposits and oxidation from exhaust tips. It's safe to use on chrome and stainless steel tips.",
    proTip: "💡 Pro Tip: Use fine-grade steel wool (0000 grade) to avoid scratching. Work in circular motions and apply light pressure.",
  },
  {
    id: "step3",
    title: "Step 3 — Rinse the Exhaust Tips",
    instruction: "After scrubbing, rinse the exhaust tips thoroughly with pressure water to remove all the degreaser and loosened carbon.",
    area: "💨 Exhaust Tips — Rinse",
    question: "After scrubbing exhaust tips, what do you do next?",
    choices: [
      { id: "rinse",      label: "Pressure Rinse", image: ASSETS.greenBrush },
      { id: "dryTowel",   label: "Dry with Towel", image: ASSETS.allPurpose },
      { id: "moreWool",   label: "More Steel Wool", image: ASSETS.steelWool },
    ],
    correctId: "rinse",
    wrongExplanation: "❌ Wrong! You must rinse off all the chemical and loosened carbon before drying. Skipping the rinse leaves residue.",
    correctExplanation: "✅ Correct! Rinse thoroughly after scrubbing to flush all the degreaser and carbon deposits away.",
    proTip: "💡 Pro Tip: Rinse inside the tip too — carbon and degreaser residue inside will bake on and become harder to remove next time.",
  },
  {
    id: "step4",
    title: "Step 4 — Dry and Polish with All-Purpose Towel",
    instruction: "After rinsing, immediately dry the exhaust tips with the All-Purpose Microfiber towel. Wipe in circular motions to bring out the shine.",
    area: "💨 Exhaust Tips — Polish",
    question: "Which towel do you use to dry and polish the exhaust tips?",
    choices: [
    ...
    wrongExplanation: "❌ Wrong! Brake Buster is a chemical. The Barrel Blade is a brush. Use the All-Purpose Microfiber to dry and polish.",
    correctExplanation: "✅ Correct! The All-Purpose Microfiber towel is used to dry and buff the exhaust tips to a shine.",
    proTip: "💡 Pro Tip: Dry exhaust tips immediately after rinsing — water spots on chrome tips are very visible and hard to remove once dry.",
  },
];
...
export default function ExhaustTipsTraining() {
  ...
  const { applyOverrides, moduleVideoUrl: hookModuleVideoUrl } = useStepOverrides("exhaust-tips");
  ...
  const handleNext = useCallback(async () => {
    if (currentStep < STEPS.length - 1) {
      ...
      if (employee?.employeeId) {
        await progressMutation.mutateAsync({ employeeId: employee.employeeId, moduleId: "TM_EXHAUST", completedSteps: steps.map((s) => s.id).join(","), isModuleCompleted: "yes", completedAt: new Date() });
      }
    }
    ...
    return (
      <ScreenContainer edges={["left", "right"]} className="p-6">
        <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: "center", justifyContent: "center", gap: 24, paddingVertical: 32 }}>
          ...
          <Text style={{ fontSize: 28, fontWeight: "800", color: colors.foreground, textAlign: "center" }}>{passed ? "Exhaust Tips Certified!" : "Keep Practicing!"}</Text>
          <Text style={{ fontSize: 16, color: colors.muted, textAlign: "center" }}>{passed ? "Exhaust Tips module complete. Progress saved." : "Review the steps and try again."}</Text>
  ...
  if (moduleVideoWatched && !toolsViewed) {
    return (
      <ScreenContainer edges={["left", "right"]}>
        <ModuleToolsScreen
          moduleKey={"exhaust-tips"}
          moduleName={"Exhaust Tips"}
    ...
    <ScreenContainer edges={["left", "right"]}>
      <ScrollView ref={scrollRef} contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
        <View style={{ paddingHorizontal: 16, paddingTop: Math.max(insets.top, 12), paddingBottom: 8, flexDirection: "row", alignItems: "center", gap: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 13, fontWeight: "600", color: colors.muted }}>💨 Exhaust Tips</Text>
