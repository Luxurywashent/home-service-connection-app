...
export default function AdminInvestorDetailScreen() {
  ...
  if (detail.isLoading) {
    return <ScreenContainer edges={["top", "left", "right"]}><View style={styles.center}><ActivityIndicator size="large" color={colors.primary} /></View></ScreenContainer>;
  }
  ...
  return (
    <ScreenContainer edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <TouchableOpacity onPress={() => router.replace("/(investor)/admin-investors" as any)} style={styles.back}>
        ...
        {activeTab === "documents" && (
          <View>
            ...
            <TouchableOpacity
              style={[styles.saveBtn, { backgroundColor: colors.primary }]}
              onPress={() => router.push({ pathname: "/(investor)/admin-investor-detail" as any, params: { investorId } })}
            >
