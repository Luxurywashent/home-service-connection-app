...
const NAV_CARDS: AdminNavCard[] = [
  { icon: "people", title: "Investors", subtitle: "Manage all investor accounts", route: "/(investor)/admin-investors", color: "#7C3AED" },
  { icon: "trending-up", title: "Investments", subtitle: "View & manage investments", route: "/(investor)/admin-investments", color: "#059669" },
  { icon: "attach-money", title: "Payments", subtitle: "Record & track payments", route: "/(investor)/admin-payments", color: "#D97706" },
  { icon: "folder", title: "Documents", subtitle: "Upload & manage documents", route: "/(investor)/admin-documents", color: "#2563EB" },
  { icon: "campaign", title: "Investor Updates", subtitle: "Post updates to investors", route: "/(investor)/admin-investor-updates", color: "#0891B2" },
  { icon: "support-agent", title: "Support Requests", subtitle: "Respond to investor inquiries", route: "/(investor)/admin-investor-support", color: "#DC2626" },
  { icon: "history", title: "Audit Log", subtitle: "View all activity history", route: "/(investor)/admin-audit-log", color: "#6B7280" },
];
