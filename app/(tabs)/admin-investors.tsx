...
function InvestorCard({ inv }: { inv: any }) {
  ...
  return (
    <TouchableOpacity
      ...
      onPress={() => router.push({ pathname: "/(tabs)/admin-investor-detail" as any, params: { investorId: inv.investorId } })}
      activeOpacity={0.8}
    >
    ...
    <ScreenContainer edges={["left", "right"]}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/(tabs)/admin-investor-inquiries" as any)}
        >
          <Text style={[styles.navBtnText, { color: colors.foreground }]}>📬 Investor Inquiries</Text>
          <Text style={[styles.navBtnArrow, { color: colors.primary }]}>→</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.navBtn, { backgroundColor: colors.surface, borderColor: colors.border }]}
          onPress={() => router.push("/(tabs)/admin-investor-support" as any)}
        >
        ...
        <TouchableOpacity
          style={[styles.navBtn, { backgroundColor: colors.surface, borderColor: colors.border }]}
          onPress={() => router.push("/(tabs)/admin-investor-updates" as any)}
        >
