        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.container}>
            ...
            <View style={styles.formCard}>
              ...
              <Pressable accessibilityRole="link" accessibilityLabel="Forgot password" onPress={() => router.push("/forgot-password" as any)} hitSlop={8}><Text style={styles.forgotPassword}>Forgot password?</Text></Pressable>
...
const styles = StyleSheet.create({
  ...
  errorBox: { alignItems: "center", backgroundColor: "#3B2029", borderColor: "#6D3341", borderRadius: 10, borderWidth: 1, flexDirection: "row", padding: 11 }, errorText: { color: "#FFD7DD", flex: 1, fontSize: 13, lineHeight: 18, marginLeft: 8 }, forgotPassword: { alignSelf: "flex-end", color: "#69C7FF", fontSize: 13, fontWeight: "700", marginTop: -4 }, signInButton: { alignItems: "center", backgroundColor: "#4D8DFF", borderRadius: 14, flexDirection: "row", gap: 8, justifyContent: "center", marginTop: 3, paddingVertical: 16 }, signInButtonPressed: { opacity: 0.78, transform: [{ scale: 0.985 }] }, signInText: { color: "#FFFFFF", fontSize: 16, fontWeight: "800" },
});
